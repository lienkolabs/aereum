...
func (b *Block) SetNewAudience(hash crypto.Hash, stage instructions.StageKeys) bool {
...
func (b *Block) UpdateAudience(hash crypto.Hash, stage instructions.StageKeys) bool {
...
func (b *Block) GetAudienceKeys(hash crypto.Hash) *instructions.StageKeys {
